    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        do {
            ...
            if faveCatalogArray.count == 0 {                // If there is no existing FaveViewModels, create one and fetch it again
                ...
                populateClass(newClass: newClass, context: context, name1:  "Type:", name2: "Place of Origin:", name3: "In Service:", desc1:"Heavy Tank", desc2: "Soviet Union", desc3: "1953–1996", locName: "Moscow", lat: "55.7615902", long: "37.60946")
                ...
                populateClass(newClass: newClass, context: context, name1: "Type:", name2: "Place of Origin:", name3: "In Service:", desc1: "Main Battle Tank", desc2: "West Germany", desc3: "1965-Present", locName: "Berlin", lat: "52.5176319", long: "13.4096574")
                ...
                populateClass(newClass: newClass, context: context, name1: "Type:", name2: "Place of Origin:", name3: "In Service:", desc1: "Medium Tank", desc2: "United States", desc3: "1942-1957", locName: "Washington", lat: "38.8954381", long: "-77.0312812")
                try? context.save()
            }
        } catch {
